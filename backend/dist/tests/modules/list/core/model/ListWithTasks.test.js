...
const buildTask = (listId, projectId, positionInList, taskId) => {
    ...
    return Task.create(title, listContainer, new PositiveInteger(positionInList), state, false, new TaskId(taskId), projectOwner, new None(), new None(), new None(), categories, assigned, actor, `task-created-${taskId}`);
};
...
describe('List with tasks', () => {
    it('does not allow adding a task with an invalid position', () => {
        ...
        const task = buildTask('0143c815-7220-7d64-8c42-6f2af4f9fd37', '0343c815-7220-7d64-8c42-6f2af4f9fd37', 2, '0243c815-7220-7d64-8c42-6f2af4f9fd37');
        expect(() => list.addTask(task)).toThrow(InvalidPositionInList);
    });
    it('inserts and shifts tasks in a 1-based position list', () => {
        const list = buildList();
        const firstTask = buildTask('0143c815-7220-7d64-8c42-6f2af4f9fd37', '0343c815-7220-7d64-8c42-6f2af4f9fd37', 1, '0243c815-7220-7d64-8c42-6f2af4f9fd37');
        const secondTask = buildTask('0143c815-7220-7d64-8c42-6f2af4f9fd37', '0343c815-7220-7d64-8c42-6f2af4f9fd37', 2, '0343c815-7220-7d64-8c42-6f2af4f9fd37');
        const insertedTask = buildTask('0143c815-7220-7d64-8c42-6f2af4f9fd37', '0343c815-7220-7d64-8c42-6f2af4f9fd37', 1, '0443c815-7220-7d64-8c42-6f2af4f9fd37');
    ...
    it('removes a task and updates later task positions', () => {
        ...
        const firstTask = buildTask('0143c815-7220-7d64-8c42-6f2af4f9fd37', '0343c815-7220-7d64-8c42-6f2af4f9fd37', 1, '0243c815-7220-7d64-8c42-6f2af4f9fd37');
        const secondTask = buildTask('0143c815-7220-7d64-8c42-6f2af4f9fd37', '0343c815-7220-7d64-8c42-6f2af4f9fd37', 2, '0343c815-7220-7d64-8c42-6f2af4f9fd37');
        const thirdTask = buildTask('0143c815-7220-7d64-8c42-6f2af4f9fd37', '0343c815-7220-7d64-8c42-6f2af4f9fd37', 3, '0443c815-7220-7d64-8c42-6f2af4f9fd37');
        list.addTask(firstTask);
        list.addTask(secondTask);
    ...
    it('exports a list and cascades project ownership to child tasks without emitting task events', () => {
        ...
        const list = List.create(new ListId('0143c815-7220-7d64-8c42-6f2af4f9fd37'), new ListTitle(new Text('Backlog')), new PositiveInteger(1), [
            buildTask('0143c815-7220-7d64-8c42-6f2af4f9fd37', originalProject, 1, '0243c815-7220-7d64-8c42-6f2af4f9fd37'),
...
//# sourceMappingURL=ListWithTasks.test.js.map