...
export default class Project extends Entity {
    ...
    private constructor();
    static create(id: ProjectId, projectName: ProjectName, projectDescription: ProjectDescription | None, background: ProjectBackGroundImage | ProjectBackGroundColor, backgroundType: BackgroundType, lists: List[], commentAuthorization: ProjectSetting, inmutableComment: boolean, addMemberSettings: ProjectSetting, createResourcesSettings: ProjectSetting, showCompletedTasks: boolean, actor: IdEntity, key: string): Project;
    ...
    private ensureBackgroundMatchesType;
}
